    ...
    <div className="w-screen bg-devalmostblack flex flex-col justify-center pl-4 pr-4">
      <Link to="/">
        <div className="flex flex-row items-center justify-center">
          ...
          <h1 
          className="text-devlightblue  text-3xl sm:text-3xl md:text-5xl lg:text-7xl">
          Dev Links
          </h1>
      ...
      <p 
      className="text-white text-xl flex flex-row justify-center pr-6 pb-6 w-screen text-2xl">
      Helpful links for budding software developers
      </p>
